...
#ifndef ESCCOIN_TEST_SCRIPTNUM10_H
#define ESCCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Elspero Core 0.10.0, for cross-comparison.
 */
public:
