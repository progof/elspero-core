...
#ifndef ESCCOIN_SCRIPT_STANDARD_H
#define ESCCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a CElsperoAddress
 */
...
#endif // ESCCOIN_SCRIPT_STANDARD_H
