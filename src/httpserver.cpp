...
static void http_reject_request_cb(struct evhttp_request* req, void*)
{
    ...
    evhttp_send_error(req, HTTP_SERVUESCAIL, NULL);
}

/** Event dispatcher thread */
static void ThreadHTTP(struct event_base* base, struct evhttp* http)
{
    RenameThread("elspero-http");
...
{
    RenameThread("elspero-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/elspero/elspero/pull/6990)
