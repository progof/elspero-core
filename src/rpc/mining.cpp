...
// NOTE: Unlike wallet RPC (which use ESC values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
UniValue getblocktemplate(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    https://github.com/elspero/bips/blob/master/bip-0022.mediawiki\n"
            "    https://github.com/elspero/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
...
UniValue submitblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "See https://en.elspero.it/wiki/BIP_0022 for full specification.\n"
...
UniValue estimatesmartfee(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"feerate\" : x.x,     (numeric) estimate fee-per-kilobyte (in ESC)\n"
