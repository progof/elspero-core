 ...
 */
#ifndef ESCCOIN_UTIL_H
#define ESCCOIN_UTIL_H
...
extern const char * const ESCCOIN_CONF_FILENAME;
extern const char * const ESCCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("elspero-%s", name);
