...
#ifndef ESCCOIN_WALLET_ESCTECH_H
#define ESCCOIN_WALLET_ESCTECH_H
...
#define ESCTECH_DEFAULT_INPUT_DELAY 1
#define ESCTECH_DEFAULT_OUT_DELAY 10
#define ESCTECH_DEFAULT_ENTROPY 4
...
#endif //ESCCOIN_WALLET_ESCTECH_H
