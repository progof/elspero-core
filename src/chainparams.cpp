...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vout[0].scriptPubKey.clear();
    txNew.strDZeel = "Elspero genesis block";
...
{
    const char* pszTimestamp = "Elspero game is afoot!";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 310000;
        consensus.nMajorityEnforceBlockUpgrade = 750;
        consensus.nMajorityRejectBlockOutdated = 950;
        consensus.nMajorityWindow = 1000;
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x00000d9e7dbbdc671a1ade70e247e9a18d94c4f47363c9d82dfe6838f126777d");
        ...
        genesis = CreateGenesisBlock(1565791026, 801216, 0x1f00ffff, 1, 0);

	      consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x00000d9e7dbbdc671a1ade70e247e9a18d94c4f47363c9d82dfe6838f126777d"));
        assert(genesis.hashMerkleRoot == uint256S("0x0d45a35a620908d1152320ff3f2d59076fd5782044495f34e5ee21113a0a8798"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x00000d9e7dbbdc671a1ade70e247e9a18d94c4f47363c9d82dfe6838f126777d")),
            1565791026, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("testelspero.org", "testseed.elspero.org"));
...
public:
    CDevNetParams() {
        ...
        // 6) Generate first block using RPC command "./elspero-cli generate 1"
        ...
        //vSeeds.push_back(CDNSSeedData("devnet.elspero.org", "devseed.elspero.org"));
