...
#ifndef ESCCOIN_QT_WALLETFRAME_H
#define ESCCOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, ElsperoGUI *_gui = 0);
    ~WalletFrame();
...
#endif // ESCCOIN_QT_WALLETFRAME_H
