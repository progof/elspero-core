...
#ifndef ESCCOIN_QT_ESCCOINUNITS_H
#define ESCCOIN_QT_ESCCOINUNITS_H
...
/** Elspero unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ElsperoUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ElsperoUnits(QObject *parent);

    /** Elspero units.
      @note Source: https://en.elspero.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        // Base currencies
...
typedef ElsperoUnits::Unit ElsperoUnit;

#endif // ESCCOIN_QT_ESCCOINUNITS_H
