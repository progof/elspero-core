...
#ifndef ESCCOIN_QT_ESCCOINGUI_H
#define ESCCOIN_QT_ESCCOINGUI_H
...
/**
  Elspero GUI main class. This class represents the main window of the Elspero UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ElsperoGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ElsperoGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~ElsperoGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a elspero wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
