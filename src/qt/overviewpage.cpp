...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(ElsperoUnits::ESC),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = ElsperoUnits::formatWithUnit(unit, amount, true, ElsperoUnits::separatorAlways);
        if(!confirmed)
        {
                              ...
                              const CAmount& coldStakingBalance)
{
    ...
    ui->labelBalance->setText(ElsperoUnits::formatWithUnit(unit, balance, false, ElsperoUnits::separatorAlways));
    ui->labelUnconfirmed->setText(ElsperoUnits::formatWithUnit(unit, unconfirmedBalance, false, ElsperoUnits::separatorAlways));
    ui->labelStaking->setText(ElsperoUnits::formatWithUnit(unit, stakingBalance, false, ElsperoUnits::separatorAlways));
    ui->labelColdStaking->setText(ElsperoUnits::formatWithUnit(unit, coldStakingBalance, false, ElsperoUnits::separatorAlways));
    ui->labelImmature->setText(ElsperoUnits::formatWithUnit(unit, immatureBalance, false, ElsperoUnits::separatorAlways));
    ui->labelWatchedBalance->setText(ElsperoUnits::formatWithUnit(unit, currentWatchOnlyTotalBalance, false, ElsperoUnits::separatorAlways));
    ui->labelTotal->setText(ElsperoUnits::formatWithUnit(unit, currentTotalBalance + currentWatchOnlyTotalBalance, false, ElsperoUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("ESC")
    updateDisplayUnit();
}
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(ElsperoUnits::formatWithUnit(unit, aRange[i++].Total, false, ElsperoUnits::separatorAlways));
    ui->label7dStakingStats->setText(ElsperoUnits::formatWithUnit(unit, aRange[i++].Total, false, ElsperoUnits::separatorAlways));
    ui->label30dStakingStats->setText(ElsperoUnits::formatWithUnit(unit, aRange[i++].Total, false, ElsperoUnits::separatorAlways));
    ui->label1yStakingStats->setText(ElsperoUnits::formatWithUnit(unit, aRange[i++].Total, false, ElsperoUnits::separatorAlways));
    ui->labelallStakingStats->setText(ElsperoUnits::formatWithUnit(unit, aRange[i++].Total, false, ElsperoUnits::separatorAlways));
}
