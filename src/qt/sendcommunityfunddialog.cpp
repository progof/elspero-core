    ...
    secDelay(secDelay)
{
    ...
    // Amount label
    QSettings settings;
    ui->labelRequestedAmount->setText(QString("%1 ESC / ").arg(proposal->nAmount/COIN).append("%1 EUR / ").arg(proposal->nAmount / settings.value("eurFactor", 0).toFloat()).append("%2 USD / ").arg(proposal->nAmount / settings.value("usdFactor", 0).toFloat()).append("%3 BTC").arg(proposal->nAmount / settings.value("btcFactor", 0).toFloat()));
    ...
    string warning = "By submitting the proposal a " + fee + " ESC deduction will occur from your wallet ";
    ...
    secDelay(secDelay)
{
    ...
    // Amount label
    QSettings settings;
    ui->labelRequestedAmount->setText(QString("%1 ESC / ").arg(prequest->nAmount/COIN).append("%1 EUR / ").arg(prequest->nAmount / settings.value("eurFactor", 0).toFloat()).append("%2 USD / ").arg(prequest->nAmount / settings.value("usdFactor", 0).toFloat()).append("%3 BTC").arg(prequest->nAmount / settings.value("btcFactor", 0).toFloat()));
