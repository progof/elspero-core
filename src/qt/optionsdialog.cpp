    ...
    mapper(0)
{
    ...
    ui->elsperoAtStartup->setToolTip(ui->elsperoAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->elsperoAtStartup->setText(ui->elsperoAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ElsperoUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->elsperoAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openElsperoConfButton_clicked()
{
