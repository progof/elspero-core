...
- [LXC](https://linuxcontainers.org/), see also [Gitian host docker container](https://github.com/gdm85/tenku/tree/master/docker/gitian-elspero-host/README.md).
...
git clone https://github.com/elspero/elspero-core
```
...
To build Elspero Core (for Linux, OS X and Windows) just follow the steps under 'Setup and perform
Gitian builds' in [doc/release-process.md](release-process.md#setup-and-perform-gitian-builds) in the elspero repository.
...
Output from `gbuild` will look something like
    ...
    From https://github.com/elspero/elspero-core
...
For example:
```bash
URL=https://github.com/elspero/elspero-core.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit elspero-core=${COMMIT} --url elspero-core=${URL} ../elspero-core/contrib/gitian-descriptors/gitian-arm.yml
./bin/gbuild --commit elspero-core=${COMMIT} --url elspero-core=${URL} ../elspero-core/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit elspero-core=${COMMIT} --url elspero-core=${URL} ../elspero-core/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit elspero-core=${COMMIT} --url elspero-core=${URL} ../elspero-core/contrib/gitian-descriptors/gitian-osx.yml
```
...
cd /some/root/path/
git clone https://github.com/elspero-core/elspero-detached-sigs.git

ESCPATH=/some/root/path/elspero
SIGPATH=/some/root/path/elspero-detached-sigs

./bin/gbuild --url elspero=${ESCPATH},signature=${SIGPATH} ../elspero/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
[ESCCoin/elspero-sigs](https://github.com/ESCCoin/elspero-sigs) repository, or if that's not possible create a pull
request.
