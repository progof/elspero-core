...
class WalletTest (ElsperoTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 ESC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 ESC with subtract fee from amount
        ...
        # Sendmany 10 ESC with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/elspero/elspero/issues/7463
        #     # '-salvagewallet',
        # ]
