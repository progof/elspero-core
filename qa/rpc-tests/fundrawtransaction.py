...
class RawTransactionsTest(ElsperoTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid elspero address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid elspero address" in e.error['message'])
