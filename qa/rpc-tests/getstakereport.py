...
class GetStakeReport(ElsperoTestFramework):
    ...
    def run_test(self):
        ...
        # Send funds to the spending address (leave me ESC for fees)
        ...
        # Make sure we have staked 2 ESC to the spending address
        ...
        # Send funds to the cold staking address (leave some ESC for fees)
        ...
        # Make sure we staked 4 ESC in spending address (2 ESC via COLD Stake)
        # So that means spending last 24h == 4
        # And staking last 24h == 2 We stake 2 ESC via COLD already
        # And merged will have the total of the spending + staking
