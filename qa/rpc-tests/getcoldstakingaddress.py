...
class GetColdStakingAddress(ElsperoTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            assert("Staking address is not a valid Elspero address" in e.error['message'])

        try:
            self.nodes[0].getcoldstakingaddress(address_one, coldstaking_address_one)
            make_addr_fail = False
        except JSONRPCException as e:
            assert("Spending address is not a valid Elspero address" in e.error['message'])
        ...
        try:
            ...
            assert(("getcoldstakingaddress \"stakingaddress\" \"spendingaddres"
                ...
                "elspero staking address.\n2. \"spendingaddress\" (string, req"
                "uired) The elspero spending address.\n\n\nExamples:\n> navcoi"
