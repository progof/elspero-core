...
`qa/pull-tester/test_framework/test_framework.py:ElsperoTestFramework.main`.
...
if 'ENABLE_WALLET' not in vars():
    ENABLE_WALLET=0
if 'ENABLE_ESCCOIND' not in vars():
    ENABLE_ESCCOIND=0
...
#Set env vars
if "ESCCOIND" not in os.environ:
    os.environ["ESCCOIND"] = BUILDDIR + '/src/elsperod' + EXEEXT
if "ESCCOINCLI" not in os.environ:
    os.environ["ESCCOINCLI"] = BUILDDIR + '/src/elspero-cli' + EXEEXT

if EXEEXT == ".exe" and "-win" not in opts:
    # https://github.com/elspero/elspero/commit/d52802551752140cf41f0d9a225a43e84404d3e9
    # https://github.com/elspero/elspero/pull/5677#issuecomment-136646964
    print("Win tests currently disabled by default.  Use -win option to enable")
    sys.exit(0)

if not (ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_ESCCOIND == 1):
    print("No rpc tests to run. Wallet, utils, and elsperod must all be enabled")
    sys.exit(0)
...
class RPCCoverage(object):
    ...
    commands per `elspero-cli help` (`rpc_interface.txt`).
